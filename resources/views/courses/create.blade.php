            ...
            <div class="module" data-module-id="${moduleCounter}">
                ...
                <div class="module-body" id="module-body-${moduleCounter}">
                    <div class="form-group">
                        ...
                        <input type="text" name="modules[${moduleCounter}][title]" required placeholder="Enter module title">
                    </div>

                    <div class="form-group">
                        <label>Module Description</label>
                        <textarea name="modules[${moduleCounter}][description]" rows="2" placeholder="Brief description of this module (optional)"></textarea>
                    </div>
        ...
        const contentHtml = `
            <div class="content-item ${nestLevel > 0 ? 'nested-content-item' : ''}" data-content-id="${contentId}" data-nest-level="${nestLevel}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="content-title" required placeholder="Enter content title">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="content-body" rows="3" placeholder="Enter content description or text"></textarea>
                </div>
